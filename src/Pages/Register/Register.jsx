...
const Register = () => {
  ...
  const { createUser, updateUserProfile, googleLogin, user,loading } = useAuth();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // Image Upload
      const imageData = await UploadPhoto(imageFile);
          ...
          >
            ...
            <div className="relative  w-full min-w-[200px]">
              ...
              {errors.name?.type === "required" && (
                <p className="text-red-500 pt-2 ml-3 ">Enter Your Name</p>
              )}
            ...
            <div className="relative  w-full min-w-[200px]">
              ...
              {errors.image?.type === "required" && (
                <p className="text-red-500 pt-2 ml-3">Upload Your Image</p>
              )}
            </div>
