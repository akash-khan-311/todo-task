const CreateTask = () => {
  return (
    <div>
      ...
      <div>
        {/* Create new task */}
        <form className="w-96 backdrop-blur-3xl bg-white/10 p-8 rounded-md">
          ...
          <div className="relative mt-5  min-w-[200px]">
            <select className="peer h-full backdrop-blur-sm bg-white/10 w-full rounded-[7px] border border-blue-gray-200 border-t-transparent  px-3 py-2.5 font-sans text-sm font-normal text-white outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-gray-600 focus:border-2 focus:border-white focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
              <option className="text-black" value="brazil">Low</option>
              <option className="text-black" value="bucharest">Moderate</option>
              <option className="text-black" value="london">High</option>
